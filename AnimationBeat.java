public class AnimationBeat{
    private static AnimationBeat beat;
    ...
    //Singleton: only one of this object can be called, so make sure 
    //all other objects call this class instead of making their own class.
